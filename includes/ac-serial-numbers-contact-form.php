...
add_action( 'init', function() {
	AC_Serial_Numbers_Helper_Features::register( 'contact_form', array(
		...
		'description'      => __( 'Display a contact/support form on your store. Use the [licencebot_contact_form] shortcode to place it on any page. Configure fields and styling from your LicenceBot Dashboard.', 'ac-serial-numbers' ),
