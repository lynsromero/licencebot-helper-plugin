...
class AC_Serial_Numbers_Settings_Help extends WC_Settings_Page {
	...
	public function __construct() {
		$this->id    = 'help';
		$this->label = __( 'Help', 'ac-serial-numbers' );
		add_filter('ac_serial_numbers_settings_tabs_array', array($this, 'add_settings_page'), 99);
...
return new AC_Serial_Numbers_Settings_Help();
