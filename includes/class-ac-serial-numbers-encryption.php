...
class AC_Serial_Numbers_Encryption {
	/**
	 * @var static
	 */
	private static $key;
	...
	public static function init() {
		...
		add_filter( 'ac_serial_numbers_maybe_encrypt', array( __CLASS__, 'maybeEncrypt' ) );
		add_filter( 'ac_serial_numbers_maybe_decrypt', array( __CLASS__, 'maybeDecrypt' ) );
	}
...
AC_Serial_Numbers_Encryption::init();
