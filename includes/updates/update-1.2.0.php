...
function wcsn_update_1_2_0() {
	...
	if ( ! wp_next_scheduled( 'ac_serial_numbers_hourly_event' ) ) {
		wp_schedule_event( time(), 'hourly', 'ac_serial_numbers_hourly_event' );
	}

	if ( ! wp_next_scheduled( 'ac_serial_numbers_daily_event' ) ) {
		wp_schedule_event( time(), 'daily', 'ac_serial_numbers_daily_event' );
	}
	...
	$options               = [
		'ac_serial_numbers_autocomplete_order'            => wcsn_update_1_2_0_get_option( 'wsn_auto_complete_order', 'yes', 'wsn_delivery_settings' ),
		'ac_serial_numbers_reuse_serial_number'           => wcsn_update_1_2_0_get_option( 'wsn_re_use_serial', 'no', 'wsn_delivery_settings' ),
		'ac_serial_numbers_disable_software_support'      => 'no',
		'ac_serial_numbers_manual_delivery'               => 'no',
		'ac_serial_numbers_hide_serial_number'            => 'yes',
		'ac_serial_numbers_revoke_status_cancelled'       => in_array( 'cancelled', wcsn_update_1_2_0_get_option( 'wsn_revoke_serial_number', [], 'wsn_delivery_settings' ) ) ? 'yes' : 'no',
		'ac_serial_numbers_revoke_status_refunded'        => in_array( 'refunded', wcsn_update_1_2_0_get_option( 'wsn_revoke_serial_number', [], 'wsn_delivery_settings' ) ) ? 'yes' : 'no',
		'ac_serial_numbers_revoke_status_failed'          => in_array( 'failed', wcsn_update_1_2_0_get_option( 'wsn_revoke_serial_number', [], 'wsn_delivery_settings' ) ) ? 'yes' : 'no',
		'ac_serial_numbers_enable_stock_notification'     => wcsn_update_1_2_0_get_option( 'wsn_admin_bar_notification_send_email', 'yes', 'wsn_notification_settings' ),
		'ac_serial_numbers_stock_threshold'               => wcsn_update_1_2_0_get_option( 'wsn_admin_bar_notification_number', '5', 'wsn_notification_settings' ),
		'ac_serial_numbers_notification_recipient'        => wcsn_update_1_2_0_get_option( 'wsn_admin_bar_notification_email', get_option( 'admin_email' ), 'wsn_notification_settings' ),
		'ac_serial_numbers_order_table_heading'              => $heading_text,
		'ac_serial_numbers_order_table_col_product_label' => 'Product',
		'ac_serial_numbers_order_table_col_key_label'     => $serial_key_label,
		'ac_serial_numbers_order_table_col_email_label'   => $serial_email_label,
		'ac_serial_numbers_order_table_col_limit_label'   => 'Activation Limit',
		'ac_serial_numbers_order_table_col_expires_label' => 'Expire Date',
		'ac_serial_numbers_order_table_col_product'       => 'yes',
		'ac_serial_numbers_order_table_col_key'           => 'yes',
		'ac_serial_numbers_order_table_col_email'         => 'no',
		'ac_serial_numbers_order_table_col_limit'         => $show_activation_limit ? 'yes' : 'no',
		'ac_serial_numbers_order_table_col_expires'       => $show_validity ? 'yes' : 'no',
		'ac_serial_numbers_install_time'                  => get_option( 'woocommerceserialnumbers_install_time' ),
